...
<body>
    <h2>UTHM Pagoh Residential College Learning Center Room Booking System</h2>
        ...
        <tr>
            ...
            <td>
                <form method="POST" action="updatedata.php">
                    ...
                    <div><br>
                        <button type="submit" class="buttonV button" name="update">CHECKED</button><br><br>
                    </div>
                </form>
            </td>
        </tr>
